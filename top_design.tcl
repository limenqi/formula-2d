...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:user:physics_axi_ip:1.0\
xilinx.com:ip:processing_system7:5.5\
xilinx.com:user:racing_renderer:1.0\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: physics_axi_ip_0, and set properties
  set physics_axi_ip_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:physics_axi_ip:1.0 physics_axi_ip_0 ]
  ...
  # Create instance: racing_renderer_0, and set properties
  set racing_renderer_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:racing_renderer:1.0 racing_renderer_0 ]
  set_property -dict [ list \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins physics_axi_ip_0/S00_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins ps7_0_axi_periph/M01_AXI] [get_bd_intf_pins racing_renderer_0/S_AXI]

  # Create port connections
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins racing_renderer_0/clk_125mhz]
  connect_bd_net -net processing_system7_0_FCLK_CLK1 [get_bd_pins physics_axi_ip_0/s00_axi_aclk] [get_bd_pins processing_system7_0/FCLK_CLK1] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins racing_renderer_0/S_AXI_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net racing_renderer_0_tmds_clk_n [get_bd_ports tmds_clk_n_0] [get_bd_pins racing_renderer_0/tmds_clk_n]
  connect_bd_net -net racing_renderer_0_tmds_clk_p [get_bd_ports tmds_clk_p_0] [get_bd_pins racing_renderer_0/tmds_clk_p]
  connect_bd_net -net racing_renderer_0_tmds_data_n [get_bd_ports tmds_data_n_0] [get_bd_pins racing_renderer_0/tmds_data_n]
  connect_bd_net -net racing_renderer_0_tmds_data_p [get_bd_ports tmds_data_p_0] [get_bd_pins racing_renderer_0/tmds_data_p]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins physics_axi_ip_0/s00_axi_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins racing_renderer_0/S_AXI_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]

  # Create address segments
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs physics_axi_ip_0/S00_AXI/S00_AXI_reg] -force
  assign_bd_address -offset 0x43C10000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs racing_renderer_0/S_AXI/reg0] -force
